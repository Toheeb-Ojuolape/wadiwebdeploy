...
export const DeactivateConfirmPassword = (props: {
  ...
  return (
    <Flex flexDirection={"column"}>
      ...
      <PasswordModalComps isOpen={isOpen} onClose={onClose}  title={"Your account has been deactivated"} subtitle={"🥹 Sorry to see you go"}   />
    </Flex>
  );
};
