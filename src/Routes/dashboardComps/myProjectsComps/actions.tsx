...
export const EditButton = (props: any) => {
  return <IconButton bg='rgba(242, 249, 253, 1)' aria-label="Edit" icon={<PenIcon />} />;
};
...
export const ImportButton = (props: any) => {
  return <IconButton bg='rgba(209, 250, 223, 1)' aria-label="Edit" icon={<Import color="rgba(18, 183, 106, 1)" />} />;
};
