...
export const AddNewProject = () => {
  ...
  const submitProject = () => {
    ...
    if(projectData?.manuscriptTitle === undefined || projectData?.researchField === undefined || projectData?.nameofJournal === undefined  || projectData?.projectType === undefined || uploadedFile === "" ){
      Swal.fire({
        icon:"info",
